...
| `mercer_island/mercer_03_quit_and_join_player.png` | `country.mercer_departure` / `.board` — approved work-uniform replacement using the canonical red-shoulder/striped-shorts uniform and established Player likeness; Brittney enters the front passenger seat and Player remains behind the wheel | `{x:.850,y:.195}` (1421,184) | `{x:.518,y:.290}` (866,273) |
