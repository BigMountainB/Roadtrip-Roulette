...
EFFECTS = [
    ...
    ("radar_cop_ahead_lockon_take1.mp3", 2.25, .82,
     "Authentic dashboard radar detector acquiring police Ka-band ahead. Two faint spaced electronic ticks, a distinct lock-on chirp, then rapidly accelerating gritty staccato pulses becoming an urgent tight brap-brap-brap warning before a clean stop. Tiny plastic speaker, realistic detector texture, readable over a game engine. No voice, police radio, siren, engine, ambience, music, sci-fi sweep, smoke-alarm tone or reverb."),
